...
<template><div :class="{dark}"><header class="top" :class="{scrolled}"><RouterLink class="brand" to="/"><span>J</span><b>Java 知识库</b></RouterLink><nav><RouterLink to="/" :class="{active:onHome}">首页</RouterLink><RouterLink to="/knowledge/java-basic/string-immutable" :class="{active:onKnowledge}">知识库</RouterLink><RouterLink to="/practice">刷题</RouterLink></nav><button class="theme" aria-label="切换主题" @click="toggleTheme">{{dark?'☀':'◐'}}</button></header><nav class="mobile-route-nav" aria-label="主要功能"><RouterLink to="/">首页</RouterLink><RouterLink to="/knowledge/java-basic/string-immutable" :class="{active:onKnowledge}">知识库</RouterLink><RouterLink to="/practice">刷题</RouterLink></nav><RouterView /></div></template>
